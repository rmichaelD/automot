...
__avg_pool3d_grad_outputs = ["output"]
...
def _avg_pool_grad(orig_input_shape, grad, ksize, strides, padding,
  ...
  Args:
    ...
    grad: A `Tensor`. Must be one of the following types: `float32`, `float64`, `int32`, `int64`, `uint8`, `int16`, `int8`, `uint16`, `half`.
...
__max_pool3d_grad_outputs = ["output"]
...
def _max_pool3d_grad(orig_input, orig_output, grad, ksize, strides, padding,
  ...
  Args:
    orig_input: A `Tensor`. Must be one of the following types: `float32`, `float64`, `int64`, `int32`, `uint8`, `uint16`, `int16`, `int8`, `complex64`, `complex128`, `qint8`, `quint8`, `qint32`, `half`.
...
__max_pool3d_grad_grad_outputs = ["output"]
...
__max_pool_grad_grad_outputs = ["output"]
...
__max_pool_grad_grad_with_argmax_outputs = ["output"]
